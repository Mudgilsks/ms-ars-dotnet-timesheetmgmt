...
namespace EventApplicationCore.Library
{
    ...
    {
        /// <summary>
        /// added for fetch password
        /// </summary>
        public static string password = ConfigurationManager.AppSettings["encryptPassword"].ToString();
        ...
        /// <summary>
        /// Removed password parameter, contain value of password
        /// </summary>
        /// <param name=""></param>
        /// <param name=""></param>
        /// <returns></returns>
