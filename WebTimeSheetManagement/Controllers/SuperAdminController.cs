...
namespace WebTimeSheetManagement.Controllers
{
    ...
    {
        /// <summary>
        /// added for fetch role name
        /// </summary>
        public string roleName = ConfigurationManager.AppSettings["adminRole"].ToString();
        ...
        public ActionResult CreateAdmin(Registration registration)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    /// removed role name
                    registration.RoleID = _IRoles.GetRolesofUserbyRolename(roleName);
